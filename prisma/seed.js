...
async function main() {
  ...
  await prisma.projeto.createMany({
    data: [
      ...
      {
        nome_projeto: "Sistema de Agendamento de Consultas",
        responsavel_tecnico: "Eduardo Souza",
        gerente_projeto: "Bianca Monteiro",
        cliente_id: 20,
      },
      {
        nome_projeto: "Sistema de Agendamento de Consultas para Brechos",
        responsavel_tecnico: "Tiago Souza",
        gerente_projeto: "Bianca Ramos",
        cliente_id: 10,
      },
    ],
  });
